...
for (i = 0 ; i < cantEstudiantes ; i++){
    ...
    let nota1 = parseInt(prompt(`Ingrese la nota 1 del estudiante #${i+1}:   `))
    let nota2 = parseInt(prompt(`Ingrese la nota 2 del estudiante #${i+1}:   `))
    let nota3 = parseInt(prompt(`Ingrese la nota 3 del estudiante #${i+1}:   `))
